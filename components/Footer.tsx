    ...
    <footer className="bg-navy text-white pt-24 pb-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 mb-24">
          ...
          {/* Coluna 1: Identidade e Missão (Substituindo a Logo) */}
          ...
          <div className="lg:col-span-3">
            <h4 className="text-white text-sm font-serif italic mb-8 border-b border-white/10 pb-4 inline-block pr-12">Navegação</h4>
            <ul className="space-y-5">
              {NAV_ITEMS.map(item => (
                <li key={item.path}>
                  <Link to={item.path} className="text-gray-400 hover:text-gold transition-colors text-[10px] uppercase font-bold tracking-widest flex items-center gap-2 group">
          ...
          <div className="lg:col-span-4">
            <h4 className="text-white text-sm font-serif italic mb-8 border-b border-white/10 pb-4 inline-block pr-12">Contato Oficial</h4>
            <ul className="space-y-6 text-sm text-gray-400 font-light">
              ...
              <li className="flex items-center gap-4 group">
                ...
                <span className="group-hover:text-gray-200 transition-colors">contato@britooliveiraassessoria.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center text-[9px] text-gray-600 font-bold uppercase tracking-ultra text-center md:text-left">
