...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section - Ajustado para "Meio Termo" */}
      <section className="relative min-h-screen flex items-center bg-navy-dark overflow-hidden py-28 md:py-40">
        <div 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 w-full flex flex-col">
          <div className="max-w-4xl">
            ...
            <h1 className="text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-serif leading-tight md:leading-[1.1] mb-7 md:mb-9 italic">
            ...
            <p className="text-gray-300 text-base md:text-lg lg:text-xl leading-relaxed mb-10 md:mb-12 max-w-2xl font-light">
