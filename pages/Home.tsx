...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section - Ajuste Refinado de Compactação */}
      <section className="relative min-h-screen flex items-center bg-navy-dark overflow-hidden py-24 md:py-34">
        <div 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 w-full flex flex-col">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-3 mb-4 md:mb-5">
              ...
              <span className="text-gold text-[8px] md:text-[10px] font-bold uppercase tracking-ultra">Brito Oliveira Assessoria Empresarial</span>
            </div>
            ...
            <p className="text-gray-300 text-sm md:text-lg lg:text-lg leading-relaxed mb-8 md:mb-10 max-w-2xl font-light">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 md:gap-5">
              ...
              <div className="flex items-center gap-3 md:gap-5 w-full sm:w-auto">
                <Link 
                  to="/#servicos" 
                  className="flex-1 sm:flex-none border border-white/20 hover:border-gold hover:text-gold text-white px-7 md:px-9 py-3.5 md:py-4.5 text-center font-semibold uppercase text-[9px] md:text-[11px] tracking-ultra transition-all backdrop-blur-sm"
                >
                  Nossos Serviços
                </Link>
